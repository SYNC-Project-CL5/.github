<img width="355" alt="image" src="https://github.com/SYNC-Project-CL5/.github/assets/74237209/d89992c8-a78c-478e-9b6b-91ba0e795602"><img src="https://capsule-render.vercel.app/api?type=waving&color=0:E34C26,10:DA5B0B,30:C6538C,75:3572A5,100:A371F7&height=100&section=header&text=&fontSize=0" width="100%"/>
...
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=jeongari)](https://github.com/anuraghazra/github-readme-stats)
...
|이름(직책, 담당 모듈)|대표 ABPA 개발 프로그램|UI5 프로그램|
  ...
  |**조병석<br>(Project Leader, PP)**|⚬ [PP] MRP<br>⚬ [PP] 공정관리<br>⚬ [PP] 생산오더 생성/승인<br>⚬ [PP] BOM 관리|⚬ [B2C] 예약프로그램<br>⚬ [B2B] 생산계획(flexible)<br>⚬ [B2B] 생산오더 조회<br>|
  |**박지영<br>(UI/UX Leader, SD)**|⚬ [SD] 판매운영계획 생성<br>⚬ [SD] 판매 오더 생성<br>⚬ [SD] 자동화 출고지시 Batch<br>⚬ [SD] 여신 관리|⚬ [B2B] 기업용 Portal<br>⚬ [B2B] 판매실적 조회<br>|
  |**유연수<br>(SD)**|⚬ [SD] 출고문서 생성 지시<br>⚬ [SD] 대금 청구 문서 생성<br>⚬ [SD] 판매오더 승인 및 관리<br>⚬ [SD] 판가 생성|⚬ [B2C] 예약프로그램<br>⚬ [B2B] 판가조회<br>⚬ [B2B] 판매오더조회<br>|
  |**김연범<br>(MM)**|⚬ [MM] 자재문서 입고, 생산, 공정, 출고, 이전 함수<br>⚬ [MM] 자재문서 조회<br>⚬ [MM] 자재마스터 관리|⚬ [B2B] 점장용 flexible 자재조회<br>⚬ [B2B] 점장용 구글API 자재조회<br>⚬ [B2B] 점장용 직영점간 자재요청<br>|
  |**김혜진<br>(MM)**|⚬ [MM] 업체 별 송장 검증 및 일괄처리<br>⚬ [MM] 구매 오더 생성<br>⚬ [MM] 구매 요청 생성<br>⚬ [MM] Info 레코드/플랜트 데이터 관리|⚬ [B2B] 사원 로그인 페이지<br>|
