...
|이름(직책, 담당 모듈)|ABPA 개발 프로그램|UI5 프로그램|
  ...
  |**박지영<br>(UI/UX Leader, SD)**|⚬ [SD] 판매운영계획 생성<br>⚬ [SD] 판매 오더 생성<br>⚬ [SD] 자동화 출고지시 Batch<br>⚬ [SD] 여신 관리|⚬ [B2b] 판가조회<br>⚬ [B2b] 판매오더조회<br>|
  |**유연수<br>(SD)**|⚬ [SD] 출고문서 생성 지시<br>⚬ [SD] 대금 청구 문서 생성<br>⚬ [SD] 판매오더 승인 및 관리<br>⚬ [SD] 판가 생성|⚬ [B2C] 예약프로그램<br>⚬ [B2b] -<br>⚬ [B2b] -<br>|
